                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="birthdate" type="text" class="form-control @error('birthdate') is-invalid @enderror" name="birthdate" value="{{ old('birthdate') }}" required  autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="officename" type="text" class="form-control @error('officename') is-invalid @enderror" name="officename" value="{{ old('officename') }}" required  autofocus>
                        ...
                        <div class="form-group row">
                            <label for="officename" class="col-md-4 col-form-label text-md-right">{{ __('Mobile No') }}</label>
                            <div class="col-md-6">
